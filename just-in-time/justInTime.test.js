...
describe('clientRegistration', () => {
    ...
    describe('Account number handler success callback', () => {
        ...
        it('should display a the bundles if the prepayment condition is ssatified',()=>{
            ...
            ` ${mockRow.vars.price}`+
            '\n');
            //expect(state.vars.bundles).toEqual(mockRow.vars);
        });
    ...
    describe('bundle Choice Handler successfull callback',()=>{
        ...
        it('should display the varieties for the bundle choosed, if the the bundle has multiple varieties',()=>{
            console.log('pppppppppppppppppppppppppppppppp'+mockBundleInputs[0].bundleId);
    ...
    describe('order Confirmation Handler successfull callback',()=>{
        ...
        it('should display a message confirming the order is complete if the order issaved in roster',()=>{
            httpClient.request.mockReturnValueOnce({status: 201});
        ...
        it('should display a message asking the user to try again later the order is not saved in roster',()=>{
            httpClient.request.mockReturnValueOnce({status: 500});
            callback();
