...
describe('bundles input handler', () => {
    ...
    it('should reprompt for bundle if user provides empty input', () => {
        ...
        const handler = bundlesHandler.getHandler('en-bu', onBundleSelected);
        handler();
    ...
    it('should call onBundleSelected once user chooses an existing bundle', () => {
        ...
        const handler = bundlesHandler.getHandler('en-bu', onBundleSelected);
        handler('1');
        expect(onBundleSelected).toHaveBeenCalledWith('en-bu', {'bundleId': 1023, 'bundleInputs': [{'bundleInputId': 123}]});
    });  
});
