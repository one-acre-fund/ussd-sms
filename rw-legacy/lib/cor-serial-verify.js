...
module.exports = function(serial_no){
    ...
    if(serial_pointer.count() === 1){
        ...
        if(serial_row.vars.product_type != 'biolite'){
            ...
            admin_alert('duplicate biolite rows in valid serial numbers for serial number: ' + serial_no, 'Duplicate Serial Numbers in valid serial numbers', 'marisa');
            slack.log('duplicate biolite rows in valid serial numbers for serial number: ' + serial_no);
            return false;
        }
