...
describe('SBCC menu handler', () => {
    ...
    it('schedules a call when user has forgotten national ID', () => {
        ...
        expect(scheduleCall).toHaveBeenCalledWith({
            lang: 'en',
            desc: 'Call back requested for forgotten national ID. User phone number is 07812345678',
    ...
    it('goes back to the non client menu when user chooses back', () => {
        ...
        expect(promptDigits).toHaveBeenCalledWith('NonClientMenu', {submitOnHash: true, maxDigits: 2, timeout: 5});
    });
