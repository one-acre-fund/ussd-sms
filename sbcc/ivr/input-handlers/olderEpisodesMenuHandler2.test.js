...
describe('Older episodes second menu handler', () => {
    ...
    it('plays episode 6 when 1 is pressed', () => {
        ...
        expect(playAudio).toHaveBeenNthCalledWith(1, 'https://telerivet.s3.amazonaws.com/files/PJ0c6396c97da49774/1611041281/3d7e4c3c2953/ep6.mp3');
    ...
    it('plays episode 5 when 2 is pressed', () => {
        ...
        expect(playAudio).toHaveBeenNthCalledWith(1, 'https://telerivet.s3.amazonaws.com/files/PJ0c6396c97da49774/1611041101/60401d859dad/ep5.mp3');
    ...
    it('plays episode 4 when 3 is pressed', () => {
        ...
        expect(playAudio).toHaveBeenNthCalledWith(1, 'https://telerivet.s3.amazonaws.com/files/PJ0c6396c97da49774/1611040960/e5c65b041920/ep4.mp3');
    ...
    it('plays episode 3 when 4 is pressed', () => {
        ...
        expect(playAudio).toHaveBeenNthCalledWith(1, 'https://telerivet.s3.amazonaws.com/files/PJ0c6396c97da49774/1611040739/11a8f2094977/ep3.mp3');
