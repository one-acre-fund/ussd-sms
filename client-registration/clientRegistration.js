...
module.exports = {
    registerHandlers: function (){
        ...
        function onPhoneNumberValidated(phoneNumber){
            ...
            global.sayText(translate('confrm_phone_prompt',{'$phone' : phoneNumber}));
